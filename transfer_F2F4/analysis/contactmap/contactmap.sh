...
~/code/containers/votca1.6.4.sif csg_map --trj ../traj.xtc --cg "/home/mason/exdrive/oligo/mappings/mapping_${PEP}-RES.xml;/home/mason/exdrive/oligo/mappings/mapping_water.xml" --top ../md.tpr --out traj-cg.gro
...
time python3 /home/mason/exdrive/oligo/Hybrid_Bottom-Up_Coarse-Grained_Model_for_Aromatic_Peptides/transfer_F2F4/analysis/contactmap/contact_map.py traj-cg-nowater.gro $PEPCT $ATOMCT > log.log 2>&1

# plot the contact map -- change per model.
# NOTE: example below shows the F2 model (model id 3, 11 beads per mol)
python3 /home/mason/exdrive/oligo/Hybrid_Bottom-Up_Coarse-Grained_Model_for_Aromatic_Peptides/transfer_F2F4/analysis/contactmap/plot_contact_map.py contactmap.txt $MODELNO $ATOMCT
