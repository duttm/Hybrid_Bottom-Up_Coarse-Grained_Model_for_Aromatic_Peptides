...
csg_fmatch -v --top topol_fm.tpr --trj traj.trr --begin $equi --options settings_CC.xml --cg "fff_cg_s.xml;water.xml"
...
csg_call --ia-type non-bonded --ia-name COO-COO --options settings_CC.xml convert_potential gromacs --clean input_COO-COO.pot table_COO_COO.xvg
